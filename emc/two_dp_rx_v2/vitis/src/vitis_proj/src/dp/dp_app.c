...
int DpPt_SetupIntrSystem()
{
	...
	Status = XIntc_Connect(IntcInstPtr, XPAR_INTC_0_DP14RXSS_0_DPRXSS_DP_IRQ_VEC_ID,
...
#if XPAR_XVPHY_NUM_INSTANCES >= 2
	/* Hook up Rx interrupt service routine */
	Status = XIntc_Connect(IntcInstPtr, XPAR_INTC_0_DP14RXSS_1_DPRXSS_DP_IRQ_VEC_ID,
				(XInterruptHandler)XDpRxSs_DpIntrHandler,
				&DpRxSsInst_1);
	if (Status != XST_SUCCESS) {
...
//		edid_monitor_linsu_screen(XPAR_DP_RX_HIER_1_VID_EDID_0_BASEADDR);
	...
	XIntc_Enable(&InterruptController, XPAR_INTC_0_DP14RXSS_0_DPRXSS_DP_IRQ_VEC_ID);
	...
	XIntc_Enable(&InterruptController, XPAR_INTC_0_DP14RXSS_1_DPRXSS_DP_IRQ_VEC_ID);
