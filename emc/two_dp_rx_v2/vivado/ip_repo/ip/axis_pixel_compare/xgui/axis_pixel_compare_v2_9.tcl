...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PPC" -widget comboBox
  ipgui::add_param $IPINST -name "TUSER_WIDTH"
  ipgui::add_param $IPINST -name "ROI_RST_XS"
  ipgui::add_param $IPINST -name "ROI_RST_XE"
  ipgui::add_param $IPINST -name "ROI_RST_YS"
  ipgui::add_param $IPINST -name "ROI_RST_YE"
