...
user.org:user:lvds4x2_1to7:1.1\
...
xilinx.com:user:axis_combiner:1.0\
...
proc create_hier_cell_processor_subsystem { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__GPIO_EMIO_WIDTH {10} \
   CONFIG.PSU__GPIO_EMIO__PERIPHERAL__ENABLE {1} \
   CONFIG.PSU__GPIO_EMIO__PERIPHERAL__IO {10} \
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M03_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M04_AXI] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M05_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins S02_AXI] [get_bd_intf_pins axi_smc/S02_AXI]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins M06_AXI] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins S03_AXI] [get_bd_intf_pins axi_smc/S03_AXI]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins S04_AXI] [get_bd_intf_pins axi_smc/S04_AXI]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins M07_AXI] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins M08_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net Conn11 [get_bd_intf_pins M09_AXI] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
...
proc create_hier_cell_lvds_s0 { parentCell nameHier } {
  ...
  set axis_combiner_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_combiner:1.0 axis_combiner_0 ]
...
proc create_root_design { parentCell } {
  ...
  set lvds4x2_1to7_0 [ create_bd_cell -type ip -vlnv user.org:user:lvds4x2_1to7:1.1 lvds4x2_1to7_0 ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_vdma_2_M_AXI_S2MM [get_bd_intf_pins axi_vdma_lwip/M_AXI_S2MM] [get_bd_intf_pins processor_subsystem/S00_AXI]
  ...
  connect_bd_intf_net -intf_net lvds_s0_M_AXIS [get_bd_intf_pins axi_vdma_lwip/S_AXIS_S2MM] [get_bd_intf_pins lvds_s0/M_AXIS]
  connect_bd_intf_net -intf_net lvds_s0_M_AXI_MM2S [get_bd_intf_pins lvds_s0/M_AXI_MM2S] [get_bd_intf_pins processor_subsystem/S03_AXI]
  connect_bd_intf_net -intf_net lvds_s0_M_AXI_S2MM [get_bd_intf_pins lvds_s0/M_AXI_S2MM] [get_bd_intf_pins processor_subsystem/S01_AXI]
  connect_bd_intf_net -intf_net lvds_s0_M_AXI_S2MM1 [get_bd_intf_pins lvds_s0/M_AXI_S2MM1] [get_bd_intf_pins processor_subsystem/S02_AXI]
  connect_bd_intf_net -intf_net lvds_s0_M_AXI_S2MM2 [get_bd_intf_pins lvds_s0/M_AXI_S2MM2] [get_bd_intf_pins processor_subsystem/S04_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M09_AXI [get_bd_intf_pins lvds_s0/S_AXI_LITE1] [get_bd_intf_pins processor_subsystem/M05_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M10_AXI [get_bd_intf_pins axi_vdma_lwip/S_AXI_LITE] [get_bd_intf_pins processor_subsystem/M03_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M11_AXI [get_bd_intf_pins axis_passthrough_mon_0/s_axi_lite] [get_bd_intf_pins processor_subsystem/M04_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M12_AXI [get_bd_intf_pins lvds_s0/S_AXI_LITE] [get_bd_intf_pins processor_subsystem/M06_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M18_AXI [get_bd_intf_pins lvds_s0/S00_AXI] [get_bd_intf_pins processor_subsystem/M07_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M19_AXI [get_bd_intf_pins lvds_s0/S_AXI_CTRL] [get_bd_intf_pins processor_subsystem/M08_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins processor_subsystem/M09_AXI] [get_bd_intf_pins xgpio_i2c_0/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins axi_gpio_lvds_reset/S_AXI] [get_bd_intf_pins processor_subsystem/M02_AXI]
  ...
  connect_bd_net -net axi_vdma_lwip_s2mm_introut [get_bd_pins axi_vdma_lwip/s2mm_introut] [get_bd_pins processor_subsystem/In1]
  ...
  connect_bd_net -net lvds_s0_intr [get_bd_pins lvds_s0/intr] [get_bd_pins processor_subsystem/In2]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins lvds4x2_1to7_0/reset] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net rst_ps8_0_300M_peripheral_aresetn [get_bd_pins axi_gpio_lvds_reset/s_axi_aresetn] [get_bd_pins axi_vdma_lwip/axi_resetn] [get_bd_pins axis_passthrough_mon_0/s_axi_lite_aresetn] [get_bd_pins lvds_s0/s_axi_lite_aresetn] [get_bd_pins processor_subsystem/peripheral_aresetn] [get_bd_pins xgpio_i2c_0/s_axi_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins util_vector_logic_0/Res]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins VCC/dout] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_gpio_lvds_reset/s_axi_aclk] [get_bd_pins axi_vdma_lwip/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_lwip/s_axi_lite_aclk] [get_bd_pins axi_vdma_lwip/s_axis_s2mm_aclk] [get_bd_pins axis_passthrough_mon_0/aclk] [get_bd_pins axis_passthrough_mon_0/s_axi_lite_aclk] [get_bd_pins lvds4x2_1to7_0/refclk] [get_bd_pins lvds_s0/m_axi_mm2s_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processor_subsystem/pl_clk0] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins xgpio_i2c_0/s_axi_aclk]
  ...
  assign_bd_address -offset 0x80070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs processor_subsystem/AXI_LITE_REG_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x80090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs xgpio_i2c_0/axi_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x80080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs processor_subsystem/axi_timer_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x80040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs lvds_s0/axi_vdma_1/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x80050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs lvds_s0/axis_pixel_compare_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x80060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs lvds_s0/axis_switch_0/S_AXI_CTRL/Reg] -force
