...
/*
 * note:it6801 pixel clock mode
 *4K is DUAL_EDGE mode
 */
//#define SIGNLE_EDGE
#define DUAL_EDGE
...
#if (defined SIGNLE_EDGE)
	hdmirxwr(0x51, 0x00);
#elif (defined DUAL_EDGE)
	hdmirxwr(0x51, 0x40);
#endif
...
/***********************************************************/
	...
	HPDCtrl(0); /* HPD 控制：初始化前拉低/释放热插拔检测，具体电平依 IT6801 封装 */
...
//	EDIDRAMInitial(Edid_Block);	// EDID RAM 初始化
	EDIDRAMInitial(edid_1080p_30fps);	// EDID RAM 初始化
//	EDIDRAMInitial(edid_4k_30fps);	//
