...
#endif
#if (XPAR_XAXIS_SWITCH_NUM_INSTANCES >= 3U)
    Status = AxisSwitch(XPAR_AXIS_SWITCH_2_DEVICE_ID, &AxisSwitch2, 0, 1); //
    if (Status != XST_SUCCESS)
	{
//		Xil_Assert(__FILE__, __LINE__);
...
#endif
#if (XPAR_XAXIS_SWITCH_NUM_INSTANCES >= 4U)
    Status = AxisSwitch(XPAR_AXIS_SWITCH_3_DEVICE_ID, &AxisSwitch3, 0, 1); //
    if (Status != XST_SUCCESS)
	{
//		Xil_Assert(__FILE__, __LINE__);
...
#endif
#if (XPAR_XAXIS_SWITCH_NUM_INSTANCES >= 5U)
    Status = AxisSwitch(XPAR_AXIS_SWITCH_4_DEVICE_ID, &AxisSwitch4, 0, 0); //
    if (Status != XST_SUCCESS)
	{
//		Xil_Assert(__FILE__, __LINE__);
		bsp_printf(TXT_RED "In %s: AxisSwitch3 failed...\r\n" TXT_RST, __func__);
...
#endif
#if (XPAR_XAXIS_SWITCH_NUM_INSTANCES >= 6U)
    Status = AxisSwitch(XPAR_AXIS_SWITCH_5_DEVICE_ID, &AxisSwitch5, 0, 0); //
    if (Status != XST_SUCCESS)
	{
//		Xil_Assert(__FILE__, __LINE__);
		bsp_printf(TXT_RED "In %s: AxisSwitch3 failed...\r\n" TXT_RST, __func__);
...
#endif
#if (XPAR_XAXIS_SWITCH_NUM_INSTANCES >= 7U)
    Status = AxisSwitch(XPAR_AXIS_SWITCH_6_DEVICE_ID, &AxisSwitch6, 0, 0); //
    if (Status != XST_SUCCESS)
	{
//		Xil_Assert(__FILE__, __LINE__);
		bsp_printf(TXT_RED "In %s: AxisSwitch3 failed...\r\n" TXT_RST, __func__);
