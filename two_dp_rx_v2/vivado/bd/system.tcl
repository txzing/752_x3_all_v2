...
proc create_hier_cell_rs485_hier { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -type intr interrupt_timer
  create_bd_pin -dir O -type intr interrupt_uart
  create_bd_pin -dir I -type clk s_axi_aclk
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir O -from 0 -to 0 uart_485_en
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins axi_timer_0/S_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S_AXI2] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins uart_rtl_0] [get_bd_intf_pins axi_uartlite_0/UART]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins uart_485_en] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins interrupt_timer] [get_bd_pins axi_timer_0/interrupt]
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins interrupt_uart] [get_bd_pins axi_uartlite_0/interrupt]
  connect_bd_net -net clk_100m_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk]
...
proc create_hier_cell_processor_subsystem { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 uart_485
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M11_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M12_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M12_AXI]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins M13_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M13_AXI]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins M14_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M14_AXI]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins M15_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M15_AXI]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins M16_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M16_AXI]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins M17_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M17_AXI]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins M18_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M18_AXI]
  connect_bd_intf_net -intf_net Conn11 [get_bd_intf_pins M19_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M19_AXI]
  connect_bd_intf_net -intf_net Conn12 [get_bd_intf_pins M20_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M20_AXI]
  connect_bd_intf_net -intf_net Conn13 [get_bd_intf_pins M21_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M21_AXI]
  connect_bd_intf_net -intf_net Conn14 [get_bd_intf_pins M22_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M22_AXI]
  connect_bd_intf_net -intf_net Conn15 [get_bd_intf_pins M23_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M23_AXI]
  connect_bd_intf_net -intf_net Conn16 [get_bd_intf_pins M24_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M24_AXI]
  connect_bd_intf_net -intf_net Conn17 [get_bd_intf_pins M25_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M25_AXI]
  connect_bd_intf_net -intf_net Conn18 [get_bd_intf_pins M26_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M26_AXI]
  connect_bd_intf_net -intf_net Conn19 [get_bd_intf_pins M27_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M27_AXI]
  connect_bd_intf_net -intf_net Conn20 [get_bd_intf_pins M28_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M28_AXI]
  connect_bd_intf_net -intf_net Conn21 [get_bd_intf_pins M29_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M29_AXI]
  connect_bd_intf_net -intf_net Conn22 [get_bd_intf_pins M30_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M30_AXI]
  connect_bd_intf_net -intf_net Conn23 [get_bd_intf_pins M31_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M31_AXI]
  connect_bd_intf_net -intf_net Conn24 [get_bd_intf_pins M32_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M32_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins axi_timer_2/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI] [get_bd_intf_pins rs485_hier/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI] [get_bd_intf_pins rs485_hier/S_AXI1]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M10_AXI [get_bd_intf_pins microblaze_0_axi_periph/M10_AXI] [get_bd_intf_pins rs485_hier/S_AXI2]
  ...
  connect_bd_intf_net -intf_net processor_subsystem_uart_rtl_0 [get_bd_intf_pins uart_485] [get_bd_intf_pins rs485_hier/uart_rtl_0]

  # Create port connections
  connect_bd_net -net HW_VER_dout [get_bd_pins VERSION] [get_bd_pins AXI_LITE_REG_0/VERSION]
  connect_bd_net -net In12_1 [get_bd_pins irq_in_5] [get_bd_pins microblaze_0_xlconcat/In12]
  connect_bd_net -net In13_1 [get_bd_pins irq_in_6] [get_bd_pins microblaze_0_xlconcat/In13]
  connect_bd_net -net In3_1 [get_bd_pins irq_in_0] [get_bd_pins microblaze_0_xlconcat/In7]
  connect_bd_net -net In4_1 [get_bd_pins irq_in_1] [get_bd_pins microblaze_0_xlconcat/In8]
  connect_bd_net -net In5_1 [get_bd_pins irq_in_2] [get_bd_pins microblaze_0_xlconcat/In9]
  connect_bd_net -net In6_1 [get_bd_pins irq_in_3] [get_bd_pins microblaze_0_xlconcat/In10]
  ...
  connect_bd_net -net irq_in_10_1 [get_bd_pins irq_in_10] [get_bd_pins microblaze_0_xlconcat/In17]
  connect_bd_net -net irq_in_4_1 [get_bd_pins irq_in_4] [get_bd_pins microblaze_0_xlconcat/In11]
  connect_bd_net -net irq_in_7_1 [get_bd_pins irq_in_7] [get_bd_pins microblaze_0_xlconcat/In14]
  connect_bd_net -net irq_in_8_1 [get_bd_pins irq_in_8] [get_bd_pins microblaze_0_xlconcat/In15]
  connect_bd_net -net irq_in_9_1 [get_bd_pins irq_in_9] [get_bd_pins microblaze_0_xlconcat/In16]
  ...
  connect_bd_net -net rst_system_peripheral_aresetn [get_bd_pins aresetn_200m] [get_bd_pins axi_smc/aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_200m/peripheral_aresetn]
...
proc create_hier_cell_ethernet_subsystem { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk ddr_clk_200m
  ...
  connect_bd_intf_net -intf_net ethernet_subsystem_mdio_0 [get_bd_intf_pins mdio] [get_bd_intf_pins axi_ethernet_0/mdio]
  connect_bd_intf_net -intf_net ethernet_subsystem_rgmii_0 [get_bd_intf_pins rgmii] [get_bd_intf_pins axi_ethernet_0/rgmii]
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins axi_ethernet_0/gtx_clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins axi_ethernet_0/ref_clk] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net ddr_clk_200m_1 [get_bd_pins ddr_clk_200m] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net ethernet_subsystem_reset_rtl_0 [get_bd_pins phy_reset_out] [get_bd_pins axi_ethernet_0/phy_rst_n]
...
proc create_hier_cell_DP_RX_hier_1 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.AUX_IO_LOC {0} \
   CONFIG.C_LINK_RATE {20} \
   CONFIG.INCLUDE_AXI_IIC {0} \
...
proc create_root_design { parentCell } {
  ...
  set uart_485 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 uart_485 ]
  ...
  set rx_hpd_1 [ create_bd_port -dir O -from 0 -to 0 -type data rx_hpd_1 ]
  set uart_485_en [ create_bd_port -dir O -from 0 -to 0 uart_485_en ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins lvds_s1/S00_AXI] [get_bd_intf_pins processor_subsystem/M28_AXI]
  ...
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins processor_subsystem/M32_AXI] [get_bd_intf_pins xgpio_i2c_0/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_CTRL_1 [get_bd_intf_pins lvds_s1/S_AXI_CTRL] [get_bd_intf_pins processor_subsystem/M29_AXI]
  connect_bd_intf_net -intf_net S_AXI_LITE1_1 [get_bd_intf_pins lvds_s1/S_AXI_LITE1] [get_bd_intf_pins processor_subsystem/M26_AXI]
  connect_bd_intf_net -intf_net S_AXI_LITE_1 [get_bd_intf_pins ethernet_subsystem/S_AXI_LITE] [get_bd_intf_pins processor_subsystem/M20_AXI]
  connect_bd_intf_net -intf_net S_AXI_LITE_4 [get_bd_intf_pins lvds_s1/S_AXI_LITE] [get_bd_intf_pins processor_subsystem/M27_AXI]
  ...
  connect_bd_intf_net -intf_net ethernet_subsystem_mdio_0 [get_bd_intf_ports mdio] [get_bd_intf_pins ethernet_subsystem/mdio]
  connect_bd_intf_net -intf_net ethernet_subsystem_rgmii_0 [get_bd_intf_ports rgmii] [get_bd_intf_pins ethernet_subsystem/rgmii]
  ...
  connect_bd_intf_net -intf_net processor_subsystem_M09_AXI [get_bd_intf_pins axi_vdma_lwip/S_AXI_LITE] [get_bd_intf_pins processor_subsystem/M12_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M11_AXI [get_bd_intf_pins axis_switch_0/S_AXI_CTRL] [get_bd_intf_pins processor_subsystem/M15_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M11_AXI1 [get_bd_intf_pins lvds_s0/S_AXI_LITE1] [get_bd_intf_pins processor_subsystem/M22_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M13_AXI [get_bd_intf_pins lvds_s0/S_AXI_LITE] [get_bd_intf_pins processor_subsystem/M23_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M19_AXI [get_bd_intf_pins axis_passthrough_mon_0/s_axi_lite] [get_bd_intf_pins processor_subsystem/M13_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M20_AXI [get_bd_intf_pins lvds_s0/S00_AXI] [get_bd_intf_pins processor_subsystem/M24_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M23_AXI1 [get_bd_intf_pins processor_subsystem/M30_AXI] [get_bd_intf_pins vid_phy_controller_0/vid_phy_axi4lite]
  connect_bd_intf_net -intf_net processor_subsystem_M25_AXI [get_bd_intf_pins axis_passthrough_mon_1/s_axi_lite] [get_bd_intf_pins processor_subsystem/M14_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M26_AXI [get_bd_intf_pins lvds_s0/S_AXI_CTRL] [get_bd_intf_pins processor_subsystem/M25_AXI]
  connect_bd_intf_net -intf_net processor_subsystem_M29_AXI [get_bd_intf_pins processor_subsystem/M31_AXI] [get_bd_intf_pins vid_phy_controller_1/vid_phy_axi4lite]
  connect_bd_intf_net -intf_net processor_subsystem_M35_AXI [get_bd_intf_pins axi_gpio_lvds_reset/S_AXI] [get_bd_intf_pins processor_subsystem/M11_AXI]
  ...
  connect_bd_intf_net -intf_net processor_subsystem_uart_rtl_0 [get_bd_intf_ports uart_485] [get_bd_intf_pins processor_subsystem/uart_485]
  connect_bd_intf_net -intf_net s_axi1_1 [get_bd_intf_pins DP_RX_hier_0/s_axi1] [get_bd_intf_pins processor_subsystem/M17_AXI]
  connect_bd_intf_net -intf_net s_axi1_2 [get_bd_intf_pins DP_RX_hier_1/s_axi1] [get_bd_intf_pins processor_subsystem/M19_AXI]
  connect_bd_intf_net -intf_net s_axi_1 [get_bd_intf_pins ethernet_subsystem/s_axi] [get_bd_intf_pins processor_subsystem/M21_AXI]
  connect_bd_intf_net -intf_net s_axi_dprxss_1 [get_bd_intf_pins DP_RX_hier_0/s_axi_dprxss] [get_bd_intf_pins processor_subsystem/M16_AXI]
  connect_bd_intf_net -intf_net s_axi_dprxss_2 [get_bd_intf_pins DP_RX_hier_1/s_axi_dprxss] [get_bd_intf_pins processor_subsystem/M18_AXI]
  ...
  connect_bd_net -net VCC_dout [get_bd_pins VCC/dout] [get_bd_pins processor_subsystem/vcc] [get_bd_pins vid_phy_controller_0/vid_phy_rx_axi4s_aresetn] [get_bd_pins vid_phy_controller_1/vid_phy_rx_axi4s_aresetn]
  ...
  connect_bd_net -net clk_200m_1 [get_bd_pins ethernet_subsystem/ddr_clk_200m] [get_bd_pins processor_subsystem/addn_ui_clkout1]
  ...
  connect_bd_net -net ethernet_subsystem_reset_rtl_0 [get_bd_ports phy_reset_out] [get_bd_pins ethernet_subsystem/phy_reset_out]
  ...
  connect_bd_net -net processor_subsystem_c0_ddr4_ui_clk_sync_rst [get_bd_pins ethernet_subsystem/reset] [get_bd_pins processor_subsystem/c0_ddr4_ui_clk_sync_rst]
  ...
  connect_bd_net -net processor_subsystem_gpio_io_o_0 [get_bd_ports uart_485_en] [get_bd_pins processor_subsystem/uart_485_en]
  ...
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/microblaze_0/Data] [get_bd_addr_segs processor_subsystem/rs485_hier/axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/microblaze_0/Data] [get_bd_addr_segs xgpio_i2c_0/axi_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x41C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/microblaze_0/Data] [get_bd_addr_segs processor_subsystem/rs485_hier/axi_timer_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40610000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processor_subsystem/microblaze_0/Data] [get_bd_addr_segs processor_subsystem/rs485_hier/axi_uartlite_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processor_subsystem/microblaze_0/Data] [get_bd_addr_segs DP_RX_hier_0/v_dp_rxss1_0/s_axi/Reg] -force
  assign_bd_address -offset 0x44A01000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processor_subsystem/microblaze_0/Data] [get_bd_addr_segs DP_RX_hier_1/v_dp_rxss1_0/s_axi/Reg] -force
