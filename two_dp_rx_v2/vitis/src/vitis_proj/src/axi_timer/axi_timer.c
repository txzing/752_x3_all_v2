...
int lock_timer_init(void)
{
	...
	XScuGic_SetPriorityTriggerType(IntcInstPtr, XPAR_INTC_0_TMRCTR_2_VEC_ID, 0xA0, 0x3);
#endif
	/*
	 * Connect the interrupt handler that will be called when an
	 * interrupt occurs for the device.
	 */
	Status = INTC_CONNECT(IntcInstPtr, XPAR_INTC_0_TMRCTR_2_VEC_ID,
	 ...
	 */
	INTC_CONNECT_ENABLE(IntcInstPtr, XPAR_INTC_0_TMRCTR_2_VEC_ID);
